    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#emails" role="button" aria-expanded="false" aria-controls="emails">
                ...
                <span class="link-title">Data Center</span>
                <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="emails">
                <ul class="nav sub-menu">
                    <li class="nav-item">
                        <a href="{{route('get_cabinets')}}" class="nav-link">Cabinets</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('get_documents') }}" class="nav-link">Search Student</a>
                    </li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a href="{{ route('list_tor') }}" class="nav-link">
                ...
                <span class="link-title">Enrollments</span>
            </a>
        </li>
